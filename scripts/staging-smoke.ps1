...
try {
    docker compose -p $ProjectName --env-file $EnvironmentFile config --quiet
    ...
    do {
        ...
        foreach ($service in $requiredServices) {
            $containerId = docker compose -p $ProjectName --env-file $EnvironmentFile ps -q $service
